  ...
  ?>
    <div id="videoID_<?php // echo $frontendQuizData->id; 
                      ?>">
      <video id="linkVid_<?php // echo $frontendQuizData->id; 
                          ?>" data_id="<?php // echo $frontendQuizData->id; 
                                        ?>" class="linkVid" width="320" height="240" controls style="<?php echo $style; ?>">
      ...
      <div id="quizID_<?php // echo $frontendQuizData->id; 
                      ?>" style="display: none;">
