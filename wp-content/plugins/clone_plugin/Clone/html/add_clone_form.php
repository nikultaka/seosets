  ...
  <!-- Modal -->
  <div id="loader" style="z-index:9999999999;">
    <span class="spanText" > Created <span id="currentCount">0</span> out of <span id="currentTotalPages">0</span> pages </span>
  </div>


  <!-- Modal -->  
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" style="z-index:99999999999999999">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">    
        Please create tags using the following format<br>
        {"TAG NAME":"TAG VALUE"}<br>
        where TAG NAME is the name of the tag in your page,<br>
        which will be replaced by the tag value specified in the list here.<br>
        You tag list can look as follows.Seprate each tag and tag value combination by a new line<br>
        {"LOCATION":"Bryson City NC"}<br>
        {"LOCATION":"Jewell GA"}<br>
        {"LOCATION":"Bryant AL"}<br>
        {"LOCATION":"Dawson AL"}<br>
      </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group" style="display:none;">
                      ...
                      <textarea disabled class="form-control" name="clone_tags1" id="clone_tags1" rows="4">Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem &#13;&#10;Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem&#13;&#10;Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem&#13;&#10;Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem&#13;&#10;Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem 
                      </textarea>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="tags">Tags (<a data-toggle="modal" data-target="#exampleModal">Example</a>)</label>
