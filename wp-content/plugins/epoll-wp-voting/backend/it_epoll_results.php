...
<table class="wp-table widefat fixed striped posts">
	<thead>
		<tr>
			<th>
				<a href="<?php echo admin_url('admin.php?page=it_epoll_system&view=results&id=1');?>" class=""><i class="dashicons dashicons-arrow-left-alt"></i> Go Back</a>
			</th>
...
<table class="wp-table widefat fixed striped posts it_epoll_sys_show_voter_table">
	...
	<tbody>
		<tr>
			...
			<td>
				<button type="button" class="button button-secondary it_epoll_sys_show_voter_btn">View Full Contact Details</button>
			</td>
		</tr>
...
<table class="wp-list-table widefat fixed striped posts">
    ...
    color: #fff;;">Now</sup>
			...
			<th>
				<a href="<?php echo admin_url('admin.php?page=it_epoll_system&view=voter_details&id='.get_the_id());?>" class="button button-secondary">View</a>		
			</th>
		</tr>
		<tr class="it_epoll_system_upgrade_pro_blur">
			<th>
