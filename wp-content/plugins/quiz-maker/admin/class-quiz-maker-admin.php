    ...
    public function ays_quiz_sale_message($ishmar){
        if($ishmar == 0 ){
            ...
            $content[] = '<div id="ays-quiz-dicount-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-month" class="ays_quiz_dicount_month" style="display: flex;align-items: center;justify-content: space-between;">';
                    $content[] = '<a href="https://bit.ly/3vOiSor" target="_blank" class="ays-quiz-sale-banner-link"><img src="' . AYS_QUIZ_ADMIN_URL . '/images/sale.png" style="display: block; width: 60px;"></a>';

                    $content[] = '<div style="font-size:14px; padding:12px; width: 100%;">';

                        $content[] = '<strong style="font-weight: bold;">';
                            $content[] = __( "Limited Time <span style='color:red;'>30%</span> SALE on Quiz Maker!", AYS_QUIZ_NAME );
                        $content[] = '</strong>';

                        $content[] = '<br>';

                        $content[] = '<strong style="font-size: 12px;font-weight: bold;">';
                                $content[] = __( "Welcome to summer! Start it right with all the powerful features you need for creating advanced quizzes and exams. Hurry up! Ends on July 7. <a href='https://bit.ly/3vOiSor' target='_blank'>Check it out!</a>", AYS_QUIZ_NAME );
                        $content[] = '</strong>';
                    ...
                    $content[] = '<a href="https://bit.ly/3vOiSor" class="button button-primary ays-button" id="ays-button-top-buy-now" target="_blank" style="height: 32px; display: flex; align-items: center; font-weight: 500; " >' . __( 'Buy Now !', AYS_QUIZ_NAME ) . '</a>';
                $content[] = '</div>';
            $content[] = '</div>';
